...
"""
Self-contained PDF figure/image + text extractor.
...
def extract_paper_assets(
    ...
    def _caption_near_image_on_page(page: fitz.Page, img_rect: fitz.Rect) -> Dict[str, Any]:
        ...
        for b in blocks:
            ...
            # below within 200 pts, with horizontal overlap
    ...
    for pno in range(doc.page_count):
        ...
        for img in img_list:
            ...
            # Save
            if image_format.lower() in ("jpg", "jpeg", "png"):
...
if __name__ == "__main__":
    # Edit these two lines and run:
    summary = extract_paper_assets("example.pdf", "output/")
